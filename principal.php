...
while ($rs = mysql_fetch_array($con)) {
    ...
    <td height='20' bgcolor='#006666' class='TITULO_BLANCO'>&nbsp;&nbsp;IPW</td>
            ...
            if (($tit7 == 0) && ($rs[10] == "Simon Shopping Destinations")) {
                $listado_notas.=
                        "<tr>
    <td height='20' bgcolor='#006666' class='TITULO_BLANCO'>&nbsp;&nbsp;Simon Shopping Destinations</td>
  </tr>";
                $tit7 = 1;
            }
        }
                            ...
                            <tr>
                                <td  colspan="3" align="center" valign="top"><?php
                                    if ($tema == "pra") {
                                        ...
                                        echo "<a href='#' ><img src='/site/logo_black.jpg' style='padding:30px' border='0'/></a>";
                                    }
                                    ?></td>
                            </tr>
