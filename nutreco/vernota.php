...
mysql_close($db);
if ($cant_not < 1)
    $listado_notas.= "<tr><td class='texto'>No hay notas con el criterio buscado.<br><br><a href='http://www.clipdenoticias.com/nutreco' class='vernota'>:: Volver</a></td></tr>";
?>
                            ...
                            <tr>
                                <td  colspan="3" align="center" valign="top">
                                    <div style = "background:#FFF; color: #777; font-size:18px; font-family: Helvetica; padding:4px;text-align:left;" >
                                        <div style="float:left;padding-right: 20px;"><a href="/nutreco/" border="0"><img src="./logo.png" width="700" border="0" /></a></div>
