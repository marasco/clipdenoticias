...
if ($_GET['msg'] != "") {
    switch ($_GET['msg']) {
        case "demovenc": $msg = "Su demostración del servicio ha finalizado.";
            break;
        case "nosusc": $msg = "No está suscripto a ningún servicio actualmente.";
            break;
        case "notema": $msg = "No está asociada su cuenta a algún tema en particular.";
            break;
        case "nologin": $msg = "No se encuentra logueado en el sistema.";
            break;
    }
}
if ($msg != "") {
    $msg = "<tr><td colspan='2' align='center' bgcolor='#FEEBC7' class='lnk_pagina_actual style1'>&nbsp;* " . $msg . "</td></tr>";
}
...
if (!isset($_COOKIE['usuarios'])) {
    ...
    $menu = "<table width='200' border='0' align='center' cellpadding='2' cellspacing='0' style='border:solid 1px; border-color: #cccccc; '><tr bgcolor='#006666'>
		...
		<td style='background-color:#FF6600;' id='menu_2' align='right' onMouseOver=chgColor('menu_2','#FF9900'); onMouseOut=chgColor('menu_2','#FF6600');><a href='contact_p.php?cl=" . $_COOKIE['usuarios'] . "' class='TITULO_BLANCO'><div >Soporte Técnico<strong>&nbsp;&nbsp;&raquo;</strong> </div></a> </td></tr><tr><td colspan='1' height='1'></td>
	</tr><tr valign='middle'  class='TITULO_BLANCO'>
		<td style='background-color:#FF6600;' id='menu_4' align='right' onMouseOver=chgColor('menu_4','#FF9900'); onMouseOut=chgColor('menu_4','#FF6600');><a href='index.php?logout=yes' class='TITULO_BLANCO'><div >Salir <strong>&nbsp;&nbsp;&raquo;</strong> </div></a> </td></tr>
		</table>";
}
...
<html>
    <head>
        ...
        <meta name="google-site-verification" content="MVWfmUeG9VZfuIAUk_lqnuVCgSfAdpAOfnFOCyVGyGc" />
        ...
        <meta name="Description" content="Clipping, búsqueda y recopilación diaria de noticias periodísticas en los medios de Argentina y en el mundo." >
...
<?php
if ($_COOKIE['usuarios'] != "")
    echo "<td width='100'   align='center' ><a class='LINKS_MENU'  href='contact_p.php?cl=" . $_COOKIE['usuarios'] . "'>";
else
    echo "<td width='100'   align='center' ><a class='LINKS_MENU'  href='contacto.php'>";
?>
                                ...
                                <td width="100" align="center" ><a  class="LINKS_MENU" href="empresa.php">
                                        <div id="con">Quiénes somos</div>
                    ...
                    <td width="500" rowspan="4" align="left" valign="top"><table cellpadding="2" cellspacing="0" border="0">
                            ...
                            <tr bgcolor="#006666">
                                <td colspan="2" bgcolor="#006666" class="TITULO_BLANCO"> : Descripci&oacute;n del servicio</td>
                                        ...
                                        <br>Nuestro equipo de trabajo realiza diariamente una exhaustiva lectura y una completa selección de noticias publicadas en las ediciones on line de los medios gráficos, tanto de Argentina (Capital Federal e Interior) como del exterior del país.<br><br>El monitoreo de la información se realiza a primera hora de la mañana para que Usted pueda comenzar su jornada laboral bien informado acerca de los temas vinculados a su sector y con todo el conocimiento necesario para tomar decisiones.<br><br>Según su preferencia o necesidad, el servicio puede realizarse de manera diaria, semanal, quincenal o mensual.<br><br>
                                        Todos los recortes periodísticos seleccionados se alojan en nuestra página web y Usted accede a ellos a través de un nombre de usuario y un password. De esta manera, Usted puede ingresar al servicio desde cualquier computadora y en cualquier lugar del mundo.<br><br>
    ...
    <tr><td height="30" align="center"><span class="texto_error">Copyright <?=date('Y')?> - All rights reserved - <span class="dinerotransparente">www.<span class="verde_logo">clip</span>denoticias.com</span></span></td>
    </tr><tr><td align="center"><script type="text/javascript"><!--
        google_ad_client = "pub-4941846366936304";
        /* sin borde 468 */
        google_ad_slot = "2972136956";
        google_ad_width = 468;
        google_ad_height = 60;
        //-->
            </script>
