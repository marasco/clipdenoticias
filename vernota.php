...
//Listar noticias de entre begin y end
  ...
  $db = mysql_connect("192.168.0.192","mysql_root","fran21");
                                mysql_select_db("clipping",$db);
	$query = "select DATE_FORMAT(n.fecha_nota,'%e'), DATE_FORMAT(n.fecha_nota,'%c'),DATE_FORMAT(n.fecha_nota,'%y'),  n.titulo, n.volanta, n.copete, n.texto, f.nombre, n.id, n.codigo_tema, n.tamimg, n.link, n.extra, n.extra2
	...
	while ($rs = mysql_fetch_array($con))
	{
		...
		<tr><td bgcolor='#FFFFFF' class='titulo'>
			<a href='vernota.php?id=".$idn."' class='titulo'>".$titulo."</a>
		</td></tr>
		<tr><td class='copete'>".$copete."</td></tr>
		...
		$show_link_noticia = (!empty($link_noticia))?"<br /><span class='fondo_gris fuente'>Link: <a  target='_blank' href='".$link_noticia."'>".$link_noticia."</a></span>":"";
		$show_value_media = (!empty($extra))?"<br /><span class='fondo_gris fuente'>Add Value Media: ".$extra."</a></span>":"";
		$show_pageviews = (!empty($extra2))?"<br /><span class='fondo_gris fuente'>Pageviews: ".$extra2."</a></span>":"";

		$listado_notas.="
		<tr><td height='20' align='right' valign='middle' bgcolor='#ffffff'>
			<span class='fondo_gris'>
			<span class='fuente'>&nbsp;Fuente: <span class='rojo'>".$autor."</span>
			</span>
			<span class='fecha'>, ".$fecha."&nbsp;</span>
			</span>".$show_link_noticia.$show_value_media.$show_pageviews."
			</td></tr>
		<tr><td>".$code_img."</td></tr>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','680','height','180','src','logo2','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','logo2' );  
  ...
  <tr><td colspan="3"><hr align="center" size="1" noshade="noshade" color="#CCCCCC"></td></tr>
	...
	<table width="460" style="border:solid 1px; border-color:#fcfcfc" border="0" cellspacing="6" cellpadding="0">
	 <tr>
    <td height="30" valign="middle" class="texto"><a  class="vernota" href="javascript:history.go(-1);">:: Volver  </a> &nbsp;/&nbsp; <a href="imprimir.php?id=<?php echo $_GET['id']; ?>" class="vernota">&nbsp;Versión para imprimir </a></td>
  </tr>
