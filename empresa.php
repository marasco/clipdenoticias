...
if ($_POST["btn1"]=="Ingresar")
{
  ...
  $db = mysql_connect("192.168.0.192","mysql_root","fran21");
	...
	$MOSTRAR = "Debes escribir tu nombre de usuario y contraseña.";
		...
		<td style='background-color:#FF6600;' id='menu_2' align='right' onMouseOver=chgColor('menu_2','#FF9900'); onMouseOut=chgColor('menu_2','#FF6600');><a href='contacto.php?sub=soporte' class='TITULO_BLANCO'><div >Soporte Técnico<strong>&nbsp;&nbsp;&raquo;</strong> </div></a> </td></tr><tr><td colspan='1' height='1'></td>
	</tr><tr valign='middle'  class='TITULO_BLANCO'>
		<td style='background-color:#FF6600;' id='menu_4' align='right' onMouseOver=chgColor('menu_4','#FF9900'); onMouseOut=chgColor('menu_4','#FF6600');><a href='index.php?logout=yes' class='TITULO_BLANCO'><div >Salir <strong>&nbsp;&nbsp;&raquo;</strong> </div></a> </td></tr>
		</table>";
			}
  ...
  <tr><td colspan="2"><hr align="center" size="1" noshade="noshade" color="#CCCCCC"></td></tr>
	...
	<td width="500" rowspan="4" align="left" valign="top"><table cellpadding="2" cellspacing="0" border="0">
		...
		<tr bgcolor="#006666">
				...
				</tr><tr><td align="right"><div  class='texto_portada'> El equipo de <strong> <span style="color:#00CC66">Clip</span><span class="fuente"> de Noticias</span></strong> está conformado por un grupo de periodistas, comunicadores sociales y analistas de sistemas con una completísima experiencia en el monitoreo de medios, la selección de noticias y el armado de plataformas digitales especialmente preparadas para cada cliente en particular.<br><br>Nuestro principal objetivo es que nuestros clientes estén muy bien informados y puedan sentirse seguros para enfrentar su día laboral y estar al tanto de las oportunidades de negocio para su producto o empresa.<br><br>Para eso, nuestro equipo monitorea las noticias de los principales medios del país, la región y el mundo entero, las selecciona con especial criterio de acuerdo al requerimiento de cada cliente y se las presenta a primera hora de la mañana.<br><br>Lo que nos diferencia de otros servicios es que trabajamos para brindarle a cada cliente un servicio único y especial de acuerdo a sus necesidades.<br><br>
				      <SPAN 
