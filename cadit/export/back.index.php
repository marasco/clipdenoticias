...
$untilDate = $_POST['until'];
    if ( !empty($sinceDate )) {
        ...
        n.titulo, n.volanta, n.copete, n.texto, f.nombre, n.id, n.tamimg, n.region, n.codigo_tema 
FROM tnotas n, tautores f
WHERE (n.codigo_tema = 'cadit' OR n.codigo_tema = 'PREPAGAS' OR n.codigo_tema = 'SECTOR' OR n.codigo_tema = 'ANMAT')
AND f.id = n.fuente AND n.estado = 1 AND n.fecha_nota >= '" . $sinceDate . "' AND n.fecha_nota <='".$untilDate."' 
ORDER BY  FIELD(n.codigo_tema, 'cadit', 'sector','prepagas','anmat'), n.fecha_nota DESC ";
    }
