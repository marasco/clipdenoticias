...
$tit5=0;$tit1=0;$tit2=0;$tit3=0;$tit4=0;
	while ($rs = mysql_fetch_array($con))
	{
		if (($i>=$inicio)&&($i<$fin))
		{
			...
			$listado_notas.=
			"<tr><td style='border-right:solid 1px #cccccc; border-bottom:solid 1px #cccccc;' class='texto'>".$fecha."</td><td  class='texto' style='border-right:solid 1px #cccccc; border-bottom:solid 1px #cccccc;'>".$autor."</td><td  class='texto' style='border-right:solid 1px #cccccc; border-bottom:solid 1px #cccccc;'>".$rs[10]."</td>
			<td  class='texto' style='border-right:solid 1px #cccccc; border-bottom:solid 1px #cccccc;'><a href='vernota.php?id=".$idn."' class='texto' style='color:#003399'>".$titulo."</a></td></tr>";
		};
		$i++;
	}
	$tipo_susc = $i;
...
<body bgcolor="#ffffff">
<form name="login" method="GET" id="login" action="index2.php">
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','680','height','180','src','logo2','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','logo2' );  
    ...
    <td height="20" colspan="3" align="center" valign="middle" bgcolor="#006666"><table width="680" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="4" class="LINKS_MENU">|</td><td width="100"  align="center" ><a class="LINKS_MENU" href="index2.php">
  ...
  <tr><td colspan="3"><hr align="center" size="1" noshade="noshade" color="#CCCCCC"></td></tr>
	...
	<table width="700" style="border:solid 1px; border-color:#fcfcfc" border="0" cellspacing="6" cellpadding="0">
	 <tr>
    <td height="20" colspan="5" bgcolor="#006666" class="TITULO_BLANCO">&nbsp;: <?php echo $titulo_barra; ?></td>
  </tr>
	<?php echo $listado_notas; ?>
	

	<tr>
		<td height="20" colspan="5" align="right" valign="middle" bgcolor="#eeeeee" class="fecha"><?php echo $pie_pagina; ?>&nbsp;</td>
	</tr><tr><td colspan="2"><table width="100%"   style="border:0px;" border="0" cellspacing="6" cellpadding="0"><? echo $logos; ?>
	  <tr>
...
&nbsp;<select name="fmes" id="fmes"  class="form_textbox_60">
	...
	&nbsp;<select name="fanio" id="fanio"  class="form_4numeros">
	    ...
	    </td><td colspan='3'><table border="0" width="100%" > <? echo $blog; ?></table></td></tr>
</table>
